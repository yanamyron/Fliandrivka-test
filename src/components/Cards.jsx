...
const Cards = () => {
  return (
    ...
    <CardsBlock>
      ...
      <InfoBlock>
      <Info1>Гончарство - це старовинне ремесло, коли люди виготовляють 
      посуд руками із глини. Вони формують глиняні вироби на 
      гончарному колесі або вручну, використовуючи спеціальні 
      інструменти. Потім вироби обпалюють у печі, щоб вони стали
       міцними та водостійкими. </Info1>
      ...
      <InfoBlock>
      <Info1>Ліпка з глини - це процес формування фігур або об'єктів із 
      глини руками без використання гончарного колеса. Ліплять 
      зазвичай за допомогою рук, але можуть використовувати й інші
       інструменти, такі як ножі або різці.</Info1>
        <SessionsCard>
            <SessionsCardTitle>Групове заняття</SessionsCardTitle>
            <AboutSession>
            <Description>Проходить у групках від 3-ох до 6-ти
      ...
      <InfoBlock>
        <Info1>
         ...
         особливих інструментів або технік ліпки, декорування які зазвичай
         не виносятся на звичайне заняття. 
        </Info1>
        <Info2>
            Майстер-класи проводяться,зазвичай, раз у два тижні протягом всього робочого дня,
            тому ви без сумніву зможете його відвідати.
        </Info2>
        <Info2>
            Кількість слухачів від 3-ох до 7-ми чоловік.
        </Info2>
        <Info2>
      ...
      <InfoBlock>
        <Info1>Ми надаємо можливість придбати сертифікати як на звичайні 
            заняття так і на наші майбутні майстер-класи.
        </Info1>
        <Info2>
            Детальніше про сертифікати можна прочитати нижче.
        </Info2>
        <BthEnrolContainer>
